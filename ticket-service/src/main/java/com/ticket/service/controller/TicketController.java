...
public class TicketController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Ticket created successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"message\": \"Ticket created successfully\", \"ticketId\": 123, \"trackId\": \"TKT-20260112-001\"}"))),
        ...
        public ResponseEntity<?> createTicket(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Ticket details", required = true, content = @Content(schema = @Schema(implementation = Ticket.class), examples = @ExampleObject(value = "{\"catId\": 1, \"title\": \"Login Issue\", \"ticketBody\": \"I cannot login to my account\", \"priority\": \"high\", \"userType\": \"customer\"}"))) @RequestBody Ticket ticket,
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Tickets retrieved successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "[{\"id\": 123, \"ticketTrackId\": \"TKT-20260112-001\", \"catId\": 1, \"title\": \"Login Issue\", \"ticketBody\": \"Cannot login to my account\", \"ticketUser\": 1, \"openedTime\": \"2026-01-12T10:45:00\", \"lastReplyTime\": \"2026-01-12T11:00:00\", \"status\": \"open\", \"priority\": \"high\", \"userType\": \"customer\"}]"))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Invalid or missing JWT token", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"message\": \"Invalid Token\"}")))
        })
        @GetMapping
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Ticket retrieved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Ticket.class), examples = @ExampleObject(value = "{\"id\": 123, \"ticketTrackId\": \"TKT-20260112-001\", \"catId\": 1, \"title\": \"Login Issue\", \"ticketBody\": \"Cannot login to my account\", \"ticketUser\": 1, \"openedTime\": \"2026-01-12T10:45:00\", \"lastReplyTime\": \"2026-01-12T11:00:00\", \"status\": \"open\", \"priority\": \"high\", \"userType\": \"customer\"}"))),
